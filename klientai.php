        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                <form method="get" action="klientai.php">
                    <div class="form-group">
                        <!-- Prisideda nematomas input, kuris rikiuojant "mato" ir miestus -->
            ...
            <form method="get" action="klientai.php">                    
                    <div class="form-group">
                        <!-- Prisideda 2 nematomai input, kurie filtruojant miestus "mato" ir rikiavimo stulpelius ir pagal ka rikiuojame. -->
